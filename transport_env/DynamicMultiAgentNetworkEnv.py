...
from transport_env.DynamicBaseNetworkEnv import DynamicBaseTransportationNetworkEnv


class DynamicMultiAgentTransportationNetworkEnvironment(DynamicBaseTransportationNetworkEnv):
    ...
    def __init__(self, config) -> None:
        ...
        for t in self.trips:
            ...
            vehicles_in_components[self.base.nodes[t.destination]['component']][1] += 1
